...
p1 <- ggplot() + theme_void() | fig3.b | fig2.d  + theme(legend.position = "right")
p2 <- fig3.f/ fig3.g
  
p3 <-  fig3.d +theme(legend.position = "bottom") | fig3.e +theme(legend.position = "bottom") | p2 

figure3 <- p1 / p3 + plot_annotation(tag_levels = "a", tag_prefix = "(", tag_suffix = ")")
saveManuscriptPlot(figure3,16,9)
```
...
p2 <- (fig6.c + labs(tag="(c)")) / (fig6.d + labs(tag="(d)")) / (fig6.e + labs(tag="(e)")) / (fig6.f + labs(tag="(f)"))
